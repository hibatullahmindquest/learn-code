...
export const TIKTOK_URL = 'https://www.tiktok.com/@nuaybeauty_';
...
export const services = [
  {
    ...
    price: 100,
    duration: '75 min',
    longevityEn: 'Lasts 6–8 weeks',
    longevityBm: 'Tahan 6–8 minggu',
    image: '/images/nuay-studio-1.avif',
    badge: 'Most Popular',
    bookingUrl: null,
    featured: true,
  },
  {
    ...
    price: 100,
    duration: '60 min',
    longevityEn: 'Lasts up to 6 weeks',
    longevityBm: 'Tahan sehingga 6 minggu',
    image: '/images/nuay-studio-2.avif',
    badge: null,
    bookingUrl: null,
    featured: true,
  },
  {
    ...
    price: 100,
    duration: '30 min',
    longevityEn: 'Lasts 2–3 weeks',
    longevityBm: 'Tahan 2–3 minggu',
    image: '/images/nuay-studio-3.avif',
    badge: null,
    bookingUrl: null,
    featured: true,
  },
  {
    ...
    price: 100,
    duration: '30 min',
    longevityEn: 'Lasts 2–4 weeks',
    longevityBm: 'Tahan 2–4 minggu',
    image: '/images/nuay-studio-4.avif',
    badge: null,
    bookingUrl: null,
    featured: false,
  },
  {
    ...
    price: 100,
    duration: '45 min',
    longevityEn: 'Lasts 3–4 weeks',
    longevityBm: 'Tahan 3–4 minggu',
    image: '/images/nuay-studio-1.avif',
    badge: null,
    bookingUrl: null,
    featured: false,
  },
  {
    ...
    price: 100,
    duration: '45 min',
    longevityEn: 'Results build over a course of sessions',
    longevityBm: 'Hasil terbina sepanjang siri rawatan',
    image: '/images/nuay-studio-2.avif',
    badge: 'New',
    bookingUrl: null,
    featured: false,
  },
  {
    ...
    price: 100,
    duration: '60 min',
    longevityEn: 'Best as a regular treatment',
    longevityBm: 'Terbaik sebagai rawatan berkala',
    image: '/images/nuay-studio-3.avif',
    badge: null,
    bookingUrl: null,
    featured: false,
  },
  {
    ...
    price: 100,
    duration: '30–60 min',
    longevityEn: 'Long-lasting with a full course',
    longevityBm: 'Tahan lama dengan siri lengkap',
    image: '/images/nuay-studio-4.avif',
    badge: null,
    bookingUrl: null,
    featured: false,
